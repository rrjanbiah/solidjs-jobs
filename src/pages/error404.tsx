    ...
    */
    return (
        <>
            ...
            <div class="container px-5 py-12 mx-auto bg-white">
                <div class="flex flex-wrap w-full">
                    <div class="w-full mb-6 lg:mb-0">
                        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">{pageTitle}</h1>
                        <p class="w-full leading-relaxed text-sm text-gray-400">If this is an error, please report it in the <a href="https://github.com/rrjanbiah/solidjs-jobs" class="text-gray-600 ml-1" target="_blank">GitHub project page</a>. Thank you!</p>
